...
const InvestmentPortfolioHomePage = () => {
        ...
        <div className="bg-white rounded-lg p-6 shadow-md">
          ...
          <div className="mt-8">
            ...
            <p className="text-gray font-normal">
              Welcome to your investment portfolio on Seed Pursuit. Here, you can
              manage and track your investments in various startups and projects.
              Explore your current investments and discover new opportunities.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
              ...
              <div className="bg-light-blue p-4 rounded-lg shadow-md">
                ...
                <p className="text-gray font-normal">
                  Description of the startup and your investment in it.
                </p>
              </div>
...
export default InvestmentPortfolioHomePage;
